const Packages = () => {
  return (
    <section className="bg-zinc-900 py-20 [&_h3]:uppercase">
      <div className="flex flex-wrap justify-center *:grow *:shrink *:basis-20 gap-8 py-6 ms-auto me-auto text-zinc-900 *:text-center  *:bg-neutral-50 *:rounded-3xl *:flex *:flex-col *:gap-4 *:p-8 *:max-w-80 *:min-w-80">
